...
#define nupa_Game__Player_vtable_index_initWithScore_ 4

static const SEL __nupa_sel_init = {.name = "init", .hash = 0x16B1D373};
static const SEL __nupa_sel_initWithScore_ = {.name = "initWithScore_", .hash = 0xB141A938};
...
NPObject * Game__Player_initWithScore_(NPObject * self, SEL _cmd, int s);
...
struct nupa_Game__Player_vtable {
    NPObject * (*init)(NPObject *, SEL);
    void (*dealloc)(NPObject *, SEL);
    NPObject * (*initWithScore_)(NPObject *, SEL, int);
};
...
NPObject * Game__Player_initWithScore_(NPObject * self, SEL _cmd, int s) {
    struct Game__Player * _self = ((struct Game__Player *)(self));
    {
        ...
        if (self) {
            ((struct Game__Player *)(self))->score = s;
        }
        return self;
    }
}
...
int main() {
    ...
    nupa_meta_init();
    {
        nupa_autoreleasepool_t * __pool = nupa_autoreleasepool_push();
        {
            ...
            Game__Player * p = ((struct nupa_Game__Player_vtable *)__nupa_tmp_0->isa->vtable)->initWithScore_(__nupa_tmp_0, __nupa_sel_initWithScore_, 99);
            printf("[using_basic] Player score: %d\n", ((struct Game__Player *)(p))->score);
            nupa_release(p);
        }
...
struct nupa_Game__Player_vtable nupa_Game__Player_vtable_inst = {
    .init = NPObject_init,
    .dealloc = NPObject_dealloc,
    .initWithScore_ = Game__Player_initWithScore_,
};
