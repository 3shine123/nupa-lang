...
int main() {
    ...
    NPObject * any = ((struct nupa_NPObject_vtable *)__nupa_tmp_0->isa->vtable)->init(__nupa_tmp_0, __nupa_sel_init);
    ((struct nupa_Animal_vtable *)any->isa->vtable)->speak(any, __nupa_sel_speak);
    return 0;
