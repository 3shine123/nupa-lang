...
int Foo_value(NPObject * self, SEL _cmd);
void Foo_setValue_(NPObject * self, SEL _cmd, int value);
...
int Foo_value(NPObject * self, SEL _cmd) {
    return ((struct Foo *)(self))->_value;
}

void Foo_setValue_(NPObject * self, SEL _cmd, int value) {
    ((struct Foo *)(self))->_value = value;
}
...
int main() {
    ...
    nupa_meta_init();
    {
        nupa_autoreleasepool_t * __pool = nupa_autoreleasepool_push();
        {
            ...
            Foo * f = ((struct nupa_NPObject_vtable *)__nupa_tmp_0->isa->vtable)->init(__nupa_tmp_0, __nupa_sel_init);
            f->_value = 42;
            printf("%d\n", ((struct nupa_Foo_vtable *)f->isa->vtable)->value(f, __nupa_sel_value));
            nupa_release(f);
        }
