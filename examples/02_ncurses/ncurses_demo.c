...
int main(void) {
    nupa_meta_init();
    {
        ...
        Terminal__Ncurses__Window * win = (Terminal__Ncurses__Window *)(((struct nupa_vtable *)__nupa_tmp_8->isa->vtable)->initWithRect_y_w_h_(__nupa_tmp_8, __nupa_sel_initWithRect_y_w_h_, 2, 2, (((struct nupa_vtable *)(scr->isa->vtable))->cols((NPObject *)(scr), __nupa_sel_cols) - 4), (((struct nupa_vtable *)(scr->isa->vtable))->rows((NPObject *)(scr), __nupa_sel_rows) - 4)));
        ((struct nupa_vtable *)(win->isa->vtable))->drawBox((NPObject *)(win), __nupa_sel_drawBox);
        ((struct nupa_vtable *)(win->isa->vtable))->print_x_text_((NPObject *)(win), __nupa_sel_print_x_text_, 1, 2, nupa_string_from_cstr("Nupa + Ncurses Demo"));
        NPObject *__nupa_tmp_9 = (NPObject_alloc(&nupa_Terminal__Ncurses__Button_class, __nupa_sel_alloc));
        Terminal__Ncurses__Button * b1 = (Terminal__Ncurses__Button *)(((struct nupa_vtable *)__nupa_tmp_9->isa->vtable)->initWithWindow_x_y_w_text_(__nupa_tmp_9, __nupa_sel_initWithWindow_x_y_w_text_, win, 4, 4, 20, nupa_string_from_cstr("Quit")));
        NPObject *__nupa_tmp_10 = (NPObject_alloc(&nupa_Terminal__Ncurses__Button_class, __nupa_sel_alloc));
        Terminal__Ncurses__Button * b2 = (Terminal__Ncurses__Button *)(((struct nupa_vtable *)__nupa_tmp_10->isa->vtable)->initWithWindow_x_y_w_text_(__nupa_tmp_10, __nupa_sel_initWithWindow_x_y_w_text_, win, 4, 6, 20, nupa_string_from_cstr("Click me")));
        NPObject *__nupa_tmp_11 = (NPObject_alloc(&nupa_Terminal__Ncurses__Label_class, __nupa_sel_alloc));
        Terminal__Ncurses__Label * lbl = (Terminal__Ncurses__Label *)(((struct nupa_vtable *)__nupa_tmp_11->isa->vtable)->initWithWindow_x_y_text_(__nupa_tmp_11, __nupa_sel_initWithWindow_x_y_text_, win, 4, 8, nupa_string_from_cstr("Press Tab to switch, Enter to select")));
        NPObject *__nupa_tmp_12 = (NPObject_alloc(&nupa_Terminal__Ncurses__TextBox_class, __nupa_sel_alloc));
        Terminal__Ncurses__TextBox * tb = (Terminal__Ncurses__TextBox *)(((struct nupa_vtable *)__nupa_tmp_12->isa->vtable)->initWithWindow_x_y_w_(__nupa_tmp_12, __nupa_sel_initWithWindow_x_y_w_, win, 4, 10, 30));
        int sel = 0;
        int running = 1;
        while (running)         {
            ((struct nupa_vtable *)(win->isa->vtable))->drawBox((NPObject *)(win), __nupa_sel_drawBox);
            ((struct nupa_vtable *)(win->isa->vtable))->print_x_text_((NPObject *)(win), __nupa_sel_print_x_text_, 1, 2, "Nupa + Ncurses Demo");
            ((struct nupa_vtable *)(lbl->isa->vtable))->draw((NPObject *)(lbl), __nupa_sel_draw);
            ((struct nupa_vtable *)(b1->isa->vtable))->setHighlight_((NPObject *)(b1), __nupa_sel_setHighlight_, sel == 0);
            ((struct nupa_vtable *)(b2->isa->vtable))->setHighlight_((NPObject *)(b2), __nupa_sel_setHighlight_, sel == 1);
            ((struct nupa_vtable *)(b1->isa->vtable))->draw((NPObject *)(b1), __nupa_sel_draw);
            ((struct nupa_vtable *)(b2->isa->vtable))->draw((NPObject *)(b2), __nupa_sel_draw);
            ((struct nupa_vtable *)(win->isa->vtable))->update((NPObject *)(win), __nupa_sel_update);
            int ch = ((struct nupa_vtable *)(scr->isa->vtable))->readChar((NPObject *)(scr), __nupa_sel_readChar);
            switch (ch)             {
                case '\t':
                    case KEY_DOWN:
                        sel = ((sel + 1) % 2);
                ...
                case '\n':
                    case KEY_ENTER:
                        if (sel == 0)                         {
                            ...
                            char * input = (char *)(((struct nupa_vtable *)(tb->isa->vtable))->edit((NPObject *)(tb), __nupa_sel_edit));
                            ((struct nupa_vtable *)(lbl->isa->vtable))->setText_((NPObject *)(lbl), __nupa_sel_setText_, (NPString *)(NPString_stringWithUTF8String_(&nupa_NPString_class, __nupa_sel_stringWithUTF8String_, input)));
                        }
                break;
                case KEY_MOUSE:
                    if (((struct nupa_vtable *)(scr->isa->vtable))->mouseEvent((NPObject *)(scr), __nupa_sel_mouseEvent))                     {
                        int mx = ((struct nupa_vtable *)(scr->isa->vtable))->mouseX((NPObject *)(scr), __nupa_sel_mouseX);
                        int my = ((struct nupa_vtable *)(scr->isa->vtable))->mouseY((NPObject *)(scr), __nupa_sel_mouseY);
                        if (((my == 6 && (mx >= 6)) && (mx < 26)))                         {
                            running = 0;
                        }
                        if (((my == 8 && (mx >= 6)) && (mx < 26)))                         {
        ...
        ((struct nupa_vtable *)(tb->isa->vtable))->release((NPObject *)(tb), __nupa_sel_release);
        ((struct nupa_vtable *)(lbl->isa->vtable))->release((NPObject *)(lbl), __nupa_sel_release);
        ((struct nupa_vtable *)(b2->isa->vtable))->release((NPObject *)(b2), __nupa_sel_release);
        ((struct nupa_vtable *)(b1->isa->vtable))->release((NPObject *)(b1), __nupa_sel_release);
